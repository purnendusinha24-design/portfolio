...
const PORTRAIT_URL = "/projects/profile.png";
    ...
    >
      ...
      <div className="flex justify-between items-end pb-7 sm:pb-8 md:pb-10 px-6 md:px-10 mt-auto relative z-20">
        <FadeIn delay={0.35} y={20}>
          <p
            className="text-[#D7E2EA] font-light leading-relaxed max-w-[320px]"
            style={{
              fontSize: "clamp(0.95rem,1.2vw,1.2rem)",
            }}
          >
            Frontend Developer focused on creating modern, responsive websites
            with clean UI and seamless user experiences.
          </p>
        </FadeIn>
